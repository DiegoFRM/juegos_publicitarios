...
export default class Game {
    ...
    public async initializeGame() : Promise<void>{
        ...
        TexturePool.textureOptions.resolution = window.devicePixelRatio;
        TexturePool.textureOptions.sampleCount = 4;
        TexturePool.textureOptions.magFilter = 'linear';
        TexturePool.textureOptions.mipmapFilter = 'linear';
        ...
        this._preloadScene = new PreloadScene(this._app, this._basicAnimations);
    ...
    public startGame() : void {
        this._effects.fadeOut(0.4, () => {
            ...
            this._mainScene = new MainScene(this._app, this._basicAnimations);
            this._app.stage.addChild(this._mainScene);
